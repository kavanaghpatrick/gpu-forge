...
## Phase 2: Triple Buffering — IN PROGRESS

## Completed Tasks (Phase 2)
- [x] 2.1 Change MAX_FRAMES_IN_FLIGHT to 3 and add uniform ring buffer

## Current Task
Awaiting next task (2.2 Wire uniform ring buffer into main.rs)
...
- prepare_dispatch encoder binds: buffer(0)=dead_list, buffer(1)=uniforms, buffer(2)=write_list, buffer(3)=emission_dispatch_args, buffer(4)=gpu_emission_params
