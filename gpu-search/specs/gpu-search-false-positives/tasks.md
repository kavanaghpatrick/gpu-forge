...
- [ ] 1.1 Create integration test harness for false positive detection
...
- [ ] 1.2 Add buffer state inspection to ContentSearchEngine
...
- [ ] 1.3 Write stale buffer detection test
...
- [ ] 1.4 Write rapid query change simulation test
...
- [ ] 1.5 POC Checkpoint -- reproduce false positives
...
- [ ] 2.1 Fix ContentSearchEngine::reset() to zero GPU buffers
...
- [ ] 2.2 Verify stale buffer test now passes
...
- [ ] 2.3 Audit and fix byte_offset calculation chain
...
- [ ] 2.4 Add match_range validation to resolve_match
...
- [ ] 3.1 Add match_range accuracy tests
...
- [ ] 3.2 Add concurrent search cancellation tests
...
- [ ] 3.3 Add large file chunk boundary tests
...
- [ ] 3.4 Add deterministic repeat search test
...
- [ ] 3.5 Add CPU verification integration test with GPU_SEARCH_VERIFY=full
...
- [ ] 4.1 Run full test suite and fix any regressions
...
- [ ] 4.2 Verify fix with manual app test
